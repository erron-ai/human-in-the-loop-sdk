...
## Objective
Maintain `human-in-the-loop-sdk` as a reliable, useful, and test-first project aligned with its primary promise:
> Standalone SDK for approval gates, escalation triggers, and review queues.
